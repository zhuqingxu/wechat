...
public class PDFMerger {
	...
	public void appendDocument(PDDocument destination, PDDocument source)
		...
		COSDictionary srcPages = (COSDictionary) srcCatalog.getCOSDictionary()
				.getDictionaryObject(COSName.PAGES);
		COSDictionary srcResources = (COSDictionary) srcPages
				.getDictionaryObject(COSName.RESOURCES);
		COSDictionary destPages = (COSDictionary) destCatalog
				.getCOSDictionary().getDictionaryObject(COSName.PAGES);
		COSDictionary destResources = (COSDictionary) destPages
				.getDictionaryObject(COSName.RESOURCES);
	...
	public static void main(String[] args) throws Exception {
		...
		merger.addSource(new File("E:/Work/Java/WebAdmin/dist/webapp/upload/html/product/report/FX0201010100Y0007SH2C.pdf"));
		...
		merger.addSource(new File("E:/Work/Java/WebAdmin/dist/webapp/upload/html/product/report/FX1001000000Y0003JiDan解锁后.pdf"));
